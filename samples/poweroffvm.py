...
def GetArgs():
   ...
   parser.add_argument('-v', '--vmuuid', required=True, action='append', help='UUID of the Instance to power off')
...
def main():
   ...
   try:
      ...
      tasks = [vm.PowerOff() for vm in vmList if vm.summary.config.instanceUuid in instance_ids]
